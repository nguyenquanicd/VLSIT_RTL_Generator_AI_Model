...
extern "C" {
#endif
void  rmaPropagate0_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_rv32im_tb_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_rv32im_tb_daidir (UB  * pcode, scalar  val);
